Code Structure (located in Code folder):

GetData.ipynb: retrieves water temperature and tide Data for Nikiski Alaska.
...
resultAnalysis.Rmd: Provides summary statistics and regression analysis on Results.csv file. 



Data and Data Sources (located in Data folder): 
